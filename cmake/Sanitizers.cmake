function(add_sanitizer sanitizer)
  ...
  target_compile_options(fsanitize_${sanitizer}
                         INTERFACE "SHELL:-fsanitize=${sanitizer}")
  target_link_options(fsanitize_${sanitizer} INTERFACE
                      "SHELL:-fsanitize=${sanitizer}")
